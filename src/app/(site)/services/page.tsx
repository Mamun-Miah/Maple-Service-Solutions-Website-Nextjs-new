...
import { ServicesChoreographyV2 } from '@/components/services/ServicesChoreographyV2'
...
import { Palette, Code2, Database, Cpu, TrendingUp, Bot, ArrowRight, CheckCircle } from 'lucide-react'
...
const services = [
  {
    ...
    features: ['Brand Strategy', 'Visual Identity', 'Brand Guidelines', 'Design Systems']
  },
  {
    id: 'product-design',
  ...
  },
  {
    ...
    features: ['Web Applications', 'Platforms', 'API Development', 'Performance']
  },
  {
    id: 'engineering',
...
const processSteps = [
  {
    number: '01',
    title: 'Discovery',
    description: 'We learn your business, goals, and audience deeply to establish shared understanding.'
  },
  {
    number: '02',
    title: 'Strategy',
    description: 'We craft a clear roadmap and strategy aligned with your business objectives.'
  },
  {
    number: '03',
    title: 'Execution',
    description: 'We build with precision, quality, and speed, keeping you informed at every step.'
  },
  {
    number: '04',
    title: 'Growth',
    description: 'We optimize and scale your solution for long-term impact and success.'
  }
]
...
const designExpertise = [
  {
    ...
    items: ['Brand positioning', 'Brand architecture', 'Brand guidelines', 'Visual identity systems']
  },
  {
    title: 'Product Design',
    items: ['User research', 'UX design', 'UI design', 'Interaction design', 'Prototyping']
  },
  {
    title: 'Design Systems',
    items: ['Component libraries', 'Design tokens', 'Documentation', 'Pattern libraries']
  }
]
...
const engineeringExpertise = [
  {
    ...
    items: ['React/Next.js', 'Vue.js', 'TypeScript', 'Performance optimization']
  },
  {
    title: 'Backend & APIs',
...
export default function ServicesPage() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const newStep = Math.max(0, Math.min(3, Math.floor(relativeScroll / stepHeight)))
    ...
    <main className="relative min-h-screen" data-page="services">
          ...
          <div className="max-w-4xl">
            ...
            >
              <motion.span
                ...
                transition={{ duration: 0.64, ease: EASE_CINEMATIC, delay: 0.2 }}
            ...
            <motion.div
              ...
              className="relative"
            >
              <span className="text-xl text-[var(--svc-muted)] max-w-2xl block">
                End-to-end capabilities from strategy to execution, all under one roof.
              </span>
              <motion.div
                initial={{ width: '0%' }}
      ...
      >
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-[var(--svc-overlay-light)]/15 via-[var(--svc-overlay-light)]/10 to-[var(--svc-overlay-light)]/5 dark:bg-gradient-to-b dark:from-[var(--svc-overlay-dark)]/25 dark:via-[var(--svc-overlay-dark)]/15 dark:to-[var(--svc-overlay-dark)]/10" />
          <picture className="w-full h-full">
            <source
        ...
        <div className="container mx-auto max-w-6xl relative">
          ...
          <div className="mb-12">
            ...
            <motion.h2
              ...
              className="text-4xl font-bold text-[var(--svc-text)]"
            >
      ...
      <section className="relative py-20 px-6">
        ...
        >
          ...
          <div className="relative bg-[var(--svc-card)] rounded-3xl p-10 md:p-16 text-center border border-[var(--svc-border)]">
            {/* Mask reveal heading */}
            <motion.h2
              initial={{ clipPath: 'inset(0 100% 0 0)' }}
              ...
              viewport={{ once: true }}
              className="text-4xl md:text-5xl font-bold text-[var(--svc-text)] mb-6 tracking-tight"
            >
            ...
            <motion.p
              ...
              viewport={{ once: true }}
              className="text-lg text-[var(--svc-muted)] max-w-2xl mx-auto mb-10"
            >
